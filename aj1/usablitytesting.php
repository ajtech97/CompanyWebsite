<html>
<head>
    <link rel="stylesheet" href="css/usablitytesting.css" type="text/css">
     <style>
...
<!--    <a href="http://pratikjoil.com/aj/"><div id="logo">LOGIIO</div></a>-->
    ...
    <div id="main">
        ...
        <div id="text1">Usability Testing</div>
<!--        <p id="p1">Responsive web design is the practice of optimizing your site to work well on devices including desktops, tablets and smartphones.</p>-->
        ...
        <div id="fulltext">   
        <p id="def">    Usability is the measure of a product's potential to accomplish the goals of the user. In information technology, the term is often used in relation to software applications and Web sites, but it can be used in relation to any product that is employed to accomplish a task (for example, a toaster, a car dashboard, or an alarm clock). Some factors used in determining product usability are ease-of-use, visual consistency, and a clear, defined process for evolution.</p>
        </div>    
