...
<!--    <a href="http://pratikjoil.com/aj/"><div id="logo">LOGIIO</div></a>-->
    <ul>
        ...
        <div id="text1">CRM Customization,Development & Implementation </div>
<!--        <p id="p1">Responsive web design is the practice of optimizing your site to work well on devices including desktops, tablets and smartphones.</p>-->
        ...
        <div id="fulltext">   
        <p id="def">   Customer relationship management (CRM) is a term that refers to practices, strategies and technologies that companies use to manage and analyze customer interactions and data throughout the customer lifecycle, with the goal of improving business relationships with customers, assisting in customer retention and driving sales growth.</p>
        </div>    
                <script>
             function teamval() 
        {
