<html>
<head>
    <link rel="stylesheet" href="css/workflowmanagementsystem.css" type="text/css">
    <style>
...
<!--    <a href="http://pratikjoil.com/aj/"><div id="logo">LOGIIO</div></a>-->
    ...
    <div id="main">
        ...
        <div id="text1">Workflow Management System </div>
<!--        <p id="p1">Responsive web design is the practice of optimizing your site to work well on devices including desktops, tablets and smartphones.</p>-->
        ...
        <div id="fulltext">   
        <p id="def">    Workflow is the series of activities that are necessary to complete a task.Each step in a workflow has a specific step before it and a specific step after it, with the exception of the first step. In a linear workflow, the first step is usually initiated by an outside event. If the workflow has a loop structure, however, the first step is initiated by the completion of the last step.</p>
        </div>    
...
$page="Workflow Management System";
