<html>
<head>
    <link rel="stylesheet" href="css/responsivewebdevelopment.css" type="text/css">
...
<!--    <a href="http://pratikjoil.com/aj/"><div id="logo">LOGIIO</div></a>-->
    ...
    <div id="main">
        ...
        <div id="text1">Responsive Web Development</div>
...
$page="Responsive web Development";
