...
<!--    <a href="http://pratikjoil.com/aj/"><div id="logo">LOGIIO</div></a>-->
    <ul>
        ...
        <div id="text1">Construction Engineering</div>
<!--        <p id="p1">Responsive web design is the practice of optimizing your site to work well on devices including desktops, tablets and smartphones.</p>-->
         ...
         <div id="fulltext">   
        <p id="def">   Construction engineering is a professional discipline that deals with the designing, planning, construction, and management of infrastructures such as roads, tunnels, bridges, airports, railroads, facilities, buildings, dams, utilities and other projects.</p>
        </div>    
