...
<!--        <p id="p1">Responsive web design is the practice of optimizing your site to work well on devices including desktops, tablets and smartphones.</p>-->
        ...
        <div id="fulltext">   
        <p id="def">    The definition of consultancy is the practice or profession of giving expert advice, especially within a particular field. When an accountant offers expert accounting advice to different businesses, this is an example of a consultancy. YourDictionary definition and usage example.</p>
        </div>    
                      <script>
             function teamval() 
        {
